...
let fn=async(url,page_no,type,first,last)=>{
    ...
    if(data.length>0)
    {
        ...
        for(let i=0;i<data.length;i++)
        {
            ...
            col.setAttribute("class","col-md-7 col-12 mt-5 mb-2");
            ...
            details.setAttribute("class","col-12 p-2 bord details text-left text-dark");
            if(type=="BOOKS")
            {
            ...
            {
                characters(details,data[i]);
            }
            else
            {
                houses(details,data[i]);
            }
        ...
        prev.onclick=async()=>{
            ...
            await fn(`https://www.anapioficeandfire.com/api/${param}?page=${page_no}&pageSize=10`,page_no,type,first,last);
