...
document.getElementById('allbooks').onclick=async()=>{
    ...
    let url=`https://www.anapioficeandfire.com/api/books?page=${page_no}&pageSize=10`;
    await fn(url,page_no,"BOOKS",1,2,true); 
...
document.getElementById('allcharacters').onclick=async()=>{
    ...
    document.getElementById('content').innerHTML="";
    document.getElementById('loading').hidden=false;
    let url=`https://www.anapioficeandfire.com/api/characters?page=${page_no}&pageSize=10`;
    await fn(url,page_no,"CHARACTERS",1,214); 
    document.getElementById('loading').hidden=true;
}
document.getElementById('allhouses').onclick=async()=>{
    ...
    document.getElementById('loading').hidden=false;
    document.getElementById('content').innerHTML="";
    let url=`https://www.anapioficeandfire.com/api/houses?page=${page_no}&pageSize=10`;
    await fn(url,page_no,"HOUSES",1,45); 
    document.getElementById('loading').hidden=true;
}
document.getElementById('button1').onclick=async()=>{
    ...
    await fn(url,page_no,"CHARACTERS",1,1); 
    document.getElementById('loading').hidden=true;
}
document.getElementById('button2').onclick=async()=>{
    ...
    await fn(url,page_no,"HOUSES",1,1); 
    document.getElementById('loading').hidden=true;
}
document.getElementById('button3').onclick=async()=>{
    ...
    await fn(url,page_no,"BOOKS",1,1); 
    document.getElementById('loading').hidden=true;
}
